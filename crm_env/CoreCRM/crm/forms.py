...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        model = User  # Specifies the model to use for form fields
        fields = ('username', 'first_name', 'last_name', 'email', 'password1', 'password2')

    # Customizing form fields to enhance user experience with placeholders and CSS classes
    def __init__(self, *args, **kwargs):
        ...
        # Customizing the password1 field (first password entry)
        ...
        # Customizing the password2 field (password confirmation)
